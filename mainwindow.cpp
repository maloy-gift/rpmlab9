    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
  ...
  connect(ui->plusZoom,  &QPushButton::clicked, this,  &MainWindow::plusZoom);
  connect(ui->minusZoom,  &QPushButton::clicked, this,  &MainWindow::minusZoom);
  connect(ui->resetZoom,  &QPushButton::clicked, this,  &MainWindow::resetZoom);
}
...
void MainWindow::plusZoom()
{
    chart->zoomIn();
    zoomValue*=2;
    ui->zoomValue->setText("Zoom x" + QString::number(zoomValue));
}
